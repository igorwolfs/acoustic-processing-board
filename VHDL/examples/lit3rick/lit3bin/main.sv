...
module main (
 ...
 Pulse_Generator_Module vc7aca6 (
  .v5a60f2(w0),
  .v05493a(w25),
  .v1955dc(w26),
  .v24805d(w27),
...
module ADC_Capture_Module (
 ...
 assign vaabc63 = w12;
 assign v959b04 = w13;
 ADC_Capture_Module_vf8ce5e vf8ce5e (
  .DCLK(w0),
  .ADC_DATA(w1),
  .TOP_T1(w2),
  .TOP_T2(w3),
...
module SPI_Interface_Module (
 ...
 assign vad664c = w6;
 assign vcdfbb7 = w7;
 SPI_Interface_Module_v69b127 v69b127 (
  .ICE_CS(w0),
  .F_MISO(w1),
  .F_MOSI(w2),
  .F_SCLK(w3),
...
module DAC_Output_Module (
 ...
 assign ve4659c = w5;
 assign v390ac4 = w6;
 DAC_Output_Module_v3f5e74 v3f5e74 (
  .DCLK(w0),
  .rst(w1),
  .dac_data(w2),
  .dac_valid(w3),
...
module Pulse_Generator_Module (
 ...
 assign v05493a = w3;
 assign w4 = v5a60f2;
 Pulse_Generator_Module_vf8ce5e vf8ce5e (
  .DCLK(w0),
  .Pdamp(w1),
  .PHV(w2),
  .PnHV(w3),
...
module Controller_Module (
 ...
 Controller_Module_vf8ce5e vf8ce5e (
  .RST(w0),
  .DCLK(w1),
  .HILO(w2),
  .from_spi(w3),
