*FDD5614P at Temp. Electrical Model
*------------------------------------------------------
.SUBCKT FDD5614P 20 10 30 50
...
Dbody 20 5x DBODY
.MODEL DBODY D(IS=4.7E-12 N=1.116224 RS=0.000695 TT=17.7n)
Ra 4 2 2.9E-2 
Rs 5x 5 0.5m
Ls 5 30 0.5n
M2 1 8 6 6 INTER
...
Dgd 4 6 DGD
Rdgd 4 6 10meg
.MODEL DGD D(M=3.7E-1 VJ=7.7E-3 CJO=652p)
M3 7 9 1 1 INTER
E3 9 1 4 1 -2
*ZX SECTION
