...
SYMATTR Prefix X
SYMATTR Description IR2302 is a high voltage, high speed power MOSFET driver with dependent high and low side referenced output channels. Vmax = 600V, Io = +200 mA -350 mA, Vcc = 20V
