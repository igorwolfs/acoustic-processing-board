...
SYMATTR Value SCR_bip
SYMATTR Prefix X
SYMATTR Description Generic SCR symbol for use with a model that you supply.
SYMATTR ModelFile SCR_bip.sub
SYMATTR Value2 IH=50MA, IGT=40MA,TON=1US, VTMIN=1V
SYMATTR SpiceLine Vdrm=50V, DVDT=50MEG,TQ=20US
SYMATTR SpiceLine2 K1=1, K2=1
PIN 16 0 NONE 0
PINATTR PinName A
